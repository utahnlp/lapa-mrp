...
Load psd transformed mrp, and load into AMRGraph as gold label, test the output with the gold AMRGraph
...
logger = logging.getLogger("mrp.psd.generator")
...
def arg_parser():
    parser = argparse.ArgumentParser(description='test_mrp_psd.py')
