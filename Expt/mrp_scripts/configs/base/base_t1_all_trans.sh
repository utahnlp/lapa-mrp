...
echo $EXP_NAME
EXP_DIR=$EXP_ROOT_DIR/base/$EXP_NAME/
...
POSTERIOR_SNT_ENCODER=transformer:psnt:{\"input_dim\":548,\"hidden_dim\":512,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":2}
