...
echo $EXP_NAME
EXP_DIR=$EXP_ROOT_DIR/base_psd/$EXP_NAME/
...
BUILD_FOLDER=$ROOT_DIR/Expt/data/mrp_data/psd_r_large_cased/
...
CONCEPT_SNT_ENCODER=bert_rnn:share:s:0,:{\"bert_config_name\":\"bert-large-cased\"}
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=rnn
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=bert_rnn:share:s:0,:{\"bert_config_name\":\"bert-large-cased\"}
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=bert_rnn:share:s:0,:{\"bert_config_name\":\"bert-large-cased\"}
...
CHAR_DIM=16
# char encoder config
CHAR_ENCODER_CONFIG={\"char_encoder_type\":\"CnnHighway\"}
