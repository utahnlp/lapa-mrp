...
echo $EXP_NAME
EXP_DIR=$EXP_ROOT_DIR/base_amr/$EXP_NAME/
...
BUILD_FOLDER=$ROOT_DIR/Expt/data/mrp_data/amr_large_cased/
...
CONCEPT_SNT_ENCODER=bert_rnn:rel:s:0,:{\"bert_config_name\":\"bert-large-cased\"}
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=bert_rnn:rel:s:0,:{\"bert_config_name\":\"bert-large-cased\"}
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=bert_rnn:rel:s:0,:{\"bert_config_name\":\"bert-large-cased\"}
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=bert_rnn:rel:s:0,:{\"bert_config_name\":\"bert-large-cased\"}
...
CHAR_DIM=64
# char encoder config
CHAR_ENCODER_CONFIG={\"char_encoder_type\":\"Cnn\"}
