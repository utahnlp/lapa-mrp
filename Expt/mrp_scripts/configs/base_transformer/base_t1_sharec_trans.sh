...
echo $EXP_NAME
EXP_DIR=$EXP_ROOT_DIR/base_transformer/$EXP_NAME/
...
BUILD_FOLDER=$CODE_BASE/amr/build/amr2eng/
...
CONCEPT_SNT_ENCODER=transformer:pamr:{\"input_dim\":548,\"hidden_dim\":256,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":4}
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=transformer:pamr:{\"input_dim\":548,\"hidden_dim\":256,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":4}
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=transformer:pamr:{\"input_dim\":549,\"hidden_dim\":256,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":4}
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=transformer:pamr:{\"input_dim\":548,\"hidden_dim\":256,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":4}
...
POSTERIOR_AMR_ENCODER=transformer:pamr:{\"input_dim\":232,\"hidden_dim\":256,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":4}
