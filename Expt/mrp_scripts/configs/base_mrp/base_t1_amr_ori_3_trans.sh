...
echo $EXP_NAME
EXP_DIR=$EXP_ROOT_DIR/base_mrp/$EXP_NAME/
...
BUILD_FOLDER=$ROOT_DIR/Expt/data/mrp_data/amr_ori/
...
OPTIM_SCHEDULER_NAME=none
# concept_snt_encoder, Model:Share:ARG
CONCEPT_SNT_ENCODER=transformer:csnt:{\"input_dim\":548,\"hidden_dim\":512,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":2}
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=transformer:csnt:{\"input_dim\":548,\"hidden_dim\":512,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":2}
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=transformer:rsnt:{\"input_dim\":549,\"hidden_dim\":512,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":2}
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=transformer:rootsnt:{\"input_dim\":548,\"hidden_dim\":512,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":2}
# use_src_encs_for_posterior
USE_SRC_ENCS_FOR_POSTERIOR=x
...
POSTERIOR_AMR_ENCODER=transformer:pamr:{\"input_dim\":232,\"hidden_dim\":256,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":2}
