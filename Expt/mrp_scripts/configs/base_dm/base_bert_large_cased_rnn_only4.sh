...
CONCEPT_SNT_ENCODER=bert_rnn:rel:s:4:{\"bert_config_name\":\"bert-large-cased\"}
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=rnn
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=bert_rnn:rel:s:4:{\"bert_config_name\":\"bert-large-cased\"}
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=bert_rnn:rel:s:4:{\"bert_config_name\":\"bert-large-cased\"}
# use_src_encs_for_posterior
USE_SRC_ENCS_FOR_POSTERIOR=
# use_src_encs_for_rel
USE_SRC_ENCS_FOR_REL=
# use_src_encs_for_root
USE_SRC_ENCS_FOR_ROOT=x
# optim json configs
