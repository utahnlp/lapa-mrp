...
echo $EXP_NAME
EXP_DIR=$EXP_ROOT_DIR/base_dm/$EXP_NAME/
...
BUILD_FOLDER=$ROOT_DIR/Expt/data/mrp_data/dm/
...
CONCEPT_SNT_ENCODER=rnn
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=rnn
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=transformer:rel:{\"input_dim\":549,\"hidden_dim\":256,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":4}
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=transformer:root:{\"input_dim\":548,\"hidden_dim\":256,\"projection_dim\":256,\"feedforward_hidden_dim\":200,\"num_layers\":2,\"num_attention_heads\":4}
