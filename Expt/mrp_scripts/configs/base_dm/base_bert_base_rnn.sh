...
CONCEPT_SNT_ENCODER=bert_rnn:rel:s:12:{\"bert_config_name\":\"bert-base-cased\"}
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=rnn
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=bert_rnn:rel:s:12:{\"bert_config_name\":\"bert-base-cased\"}
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=bert_rnn:rel:s:12:{\"bert_config_name\":\"bert-base-cased\"}
