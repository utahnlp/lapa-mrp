...
CONCEPT_SNT_ENCODER=bert-base-cased:share:d:0-2
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=bert-base-cased:share:d:3-5
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=bert-base-cased:share:d:6-8
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=bert-base-cased:share:d:9-11
