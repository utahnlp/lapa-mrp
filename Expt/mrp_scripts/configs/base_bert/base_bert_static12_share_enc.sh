...
CONCEPT_SNT_ENCODER=bert-base-cased:share:s:12
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=bert-base-cased:share:s:12
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=bert-base-cased:share:s:12
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=bert-base-cased:share:s:12
# use_src_encs_for_posterior
USE_SRC_ENCS_FOR_POSTERIOR=x
# use_src_encs_for_rel
USE_SRC_ENCS_FOR_REL=x
