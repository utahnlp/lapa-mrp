...
CONCEPT_SNT_ENCODER=bert-base-cased:concept:d:0-5
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=bert-base-cased:concept:d:0-5
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=bert-base-cased:rel:d:0-11
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=bert-base-cased:rel:d:0-11
...
OPTIM_JSON_CONFIGS='{"[bert_model]":{"lr":0.0001}}'
