...
CONCEPT_SNT_ENCODER=bert:share:d:12:{\"bert_config_name\":\"bert-base-cased\"}
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=bert:share:d:12:{\"bert_config_name\":\"bert-base-cased\"}
...
USE_SRC_ENCS_FOR_ROOT=
# optim json configs
OPTIM_JSON_CONFIGS='{"[bert_model|_scalar_mix]":{"lr":0.00005}}'
