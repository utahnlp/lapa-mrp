...
CONCEPT_SNT_ENCODER=bert-base-cased:share:d:1
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=bert-base-cased:share:d:1
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=bert-base-cased:share:d:1
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=bert-base-cased:share:d:1
