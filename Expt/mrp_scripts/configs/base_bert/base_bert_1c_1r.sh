...
CONCEPT_SNT_ENCODER=bert-base-cased:concept:d:4
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=bert-base-cased:concept:d:4
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=bert-base-cased:rel:d:4
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=bert-base-cased:rel:d:4
