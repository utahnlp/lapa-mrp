...
CONCEPT_SNT_ENCODER=bert-base-cased:concept:d:12
# posterior_snt_encoder, Model:Share:ARG
POSTERIOR_SNT_ENCODER=bert-base-cased:concept:d:12
# rel_snt_encoder, Model:Share:ARG
REL_SNT_ENCODER=bert-base-cased:rel:d:12
# root_snt_encoder, Model:Share:ARG
ROOT_SNT_ENCODER=bert-base-cased:rel:d:12
