...
$PIPE_DIR/psd_rule_system_build0.sh ${sub_name} || { echo 'psd_rule_system_build0.sh ${sub_name} failed' ; exit 1 ; }

echo "build psd data with pickle"
$PIPE_DIR/psd_data_build0.sh ${sub_name} || { echo 'psd_data_build0.sh ${sub_name} failed' ; exit 1 ; }
