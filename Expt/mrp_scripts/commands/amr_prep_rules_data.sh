...
$PIPE_DIR/amr_rule_system_build.sh ${sub_name} || { echo 'rule_system_build_amr.sh ${sub_name} failed' ; exit 1 ; }

echo "build amr data with pickle"
$PIPE_DIR/amr_data_build.sh ${sub_name} || { echo 'data_build_amr.sh ${sub_name} failed' ; exit 1 ; }
